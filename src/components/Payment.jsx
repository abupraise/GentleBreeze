...
const Payment = () => {
  ...
  const plans = [
    {
      plan: "Daily Plan",
      price: billingPeriod === "Yearly" ? "$2" : "$60",
    ...
    {
      plan: "1-On-1 Payment per Session",
    ...
    {
      plan: "6 Months Plan",
      price: billingPeriod === "Yearly" ? "$25" : "$300",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      features: ["Feature 1", "Feature 2", "Feature 3", "Feature 4"],
      availableFeatures: ["Feature 1", "Feature 2", "Feature 3", "Feature 4"],
      buttonColor: "bg-black",
    ...
    {
      plan: "1 Year Plan",
      price: billingPeriod === "Yearly" ? "$30" : "$360",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      features: ["Feature 1", "Feature 2", "Feature 3", "Feature 4"],
      availableFeatures: ["Feature 1", "Feature 2", "Feature 3", "Feature 4"],
      buttonColor: "bg-black",
...
const PricingCard = ({
  ...
  return (
    ...
    >
      <div className="mb-10">
        <div
          className={`text-opacity-100 mb-4 text-lg font-signika font-semibold ${
            isActive ? "text-white" : ""
          }`}
        >
          {plan}
        ...
        <div className="flex items-baseline mb-4">
          <span
            className={`text-opacity-100 text-6xl font-signika font-semibold mr-2 ${
              isActive ? "text-white" : ""
            }`}
          >
            {price}
          ...
          <span
            className={`text-opacity-100 text-lg font-signika font-semibold ${
              isActive ? "text-white" : ""
            }`}
          >
            / Month
        ...
        <span
          className={`text-opacity-100 text-lg font-signika font-light ${
            isActive ? "text-white" : ""
          }`}
        >
          {description}
      ...
      <ul className="mb-10 space-y-4">
        {features.map((feature, index) => (
          <li key={index} className="flex items-center space-x-4">
            ...
            <span
              className={`text-lg font-signika font-normal ${
      ...
      <button
        className={`rounded-2xl ${
          isActive ? "bg-white text-black" : buttonColor
        } w-full py-4 ${
          isActive ? "text-black" : buttonTextColor
        } font-signika font-bold text-lg`}
      >
        Choose Plan
      </button>
    </div>
