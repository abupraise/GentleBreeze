...
const reviewers = [
  ...
  { img: "Ellipse9.png", styles: "w-[7.5rem] h-[7.5rem] m-[2.2rem_0_0.3rem_0]" },
  { img: "Ellipse6.png", styles: "w-[9.4rem] h-[9.4rem] self-end" },
  { img: "Ellipse8.png", styles: "w-[11.3rem] h-[11.3rem] absolute left-[5.7rem] bottom-0" },
];
        ...
        <div className="m-[0_0_0.3rem_0] flex flex-row self-start w-[22.5rem] box-border">
          {reviewers.slice(0, 2).map((reviewer, index) => (
            <div
              ...
              style={{ backgroundImage: `url('/assets/images/${reviewer.img}')` }}
            ></div>
          ))}
        </div>
        <div
